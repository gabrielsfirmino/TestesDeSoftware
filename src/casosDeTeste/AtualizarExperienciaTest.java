...
//	}
	...
	public void TesteRemoverExperiencia() 
	{
		...
		By xpath_1 = By.xpath("/html/body/div/div[2]/section/div/div/div[6]/div[2]/table/tbody/tr[1]/td[7]/div/a[2]");
		WebElement button_1 = drive.findElement(xpath_1);
		button_1.click();
		
		By xpath_2 = By.xpath("/html/body/div/div[2]/section/div/div/div[6]/div[2]/table/tbody/tr[1]/td[7]/div/a[2]");
		WebElement button_2 = drive.findElement(xpath_2);
		button_2.click();
